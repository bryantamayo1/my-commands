...
export class Server {
  ...
  routes() {
    ...
    this.app.post(
      `${this.urlApi}${process.env.PATH_ADMIN}/commands/:id_filter`,
      validateToken,
      controlRoleUser,
      createCommand
    );
    this.app.patch(
      `${this.urlApi}${process.env.PATH_ADMIN}/commands/:id_filter/:id_command`,
      validateToken,
      controlRoleUser,
      modificateCommand
    );
    ...
    this.app.post(
      `${this.urlApi}${process.env.PATH_ADMIN}/filters`,
      validateToken,
      controlRoleUser,
      createFilter
    );
    this.app.patch(
      `${this.urlApi}${process.env.PATH_ADMIN}/filters/:id_filter`,
      validateToken,
      controlRoleUser,
      modificateFilter
    );
    ...
    // CRUD Subcategories
    this.app.use(
      `${this.urlApi}${process.env.PATH_ADMIN}/subcategories`,
      validateToken,
      controlRoleUser,
      subCategoriesRouter
    );
